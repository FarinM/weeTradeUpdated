...
public class TradeInventory{
	...
	public void nextOption(Player p){
		...
		DyeColor c = DyeColor.getByDyeData(inventory.getItem(slot).getData().getData());
	...
	private static final ItemStack getPane(TradeOption o){
		ItemStack i = new ItemStack(Material.LEGACY_STAINED_GLASS_PANE, 1, (short) o.getDye().getDyeData());
